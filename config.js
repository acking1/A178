...
global.email = 'pappuff05@gmail.com'
global.github = 'https://github.com/prabathLK/PRABATH-MD'
global.location = 'Bajkul,India'
global.gurl = 'Akash Creation' // add your username
...
module.exports = {
  ...
  botname: process.env.BOT_NAME || 'Akash Creation',
  dl_limit: process.env.DL_SIZE || '300',
  art: process.env.AUTO_RESTART || 'true',
  sudo: process.env.SUDO || '919564704717',
  alivepic: process.env.ALIVE_IMG || 'https://telegra.ph/file/ad25b2227fa2a1a01b707.jpg',
  alivemsj: process.env.ALIVE_MSJ || '*POWERD BY AKASH CREATION',
  ownername:process.env.OWNER_NAME || 'Akash',
  sessionName: process.env.SESSION_ID || 'xqkngQhL#g4AIFo0J-aQbaIEHa6hMiLScaW-nxJw-9THuEAUc9AU',
  author: process.env.PACK_INFO.split(";")[0] || 'author', 
  auto_read_status : process.env.AUTO_READ_STATUS || 'false',
  packname: process.env.PACK_INFO.split(";")[1] || 'Akash',
